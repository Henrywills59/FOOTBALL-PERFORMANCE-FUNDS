...
export class InfrastructureService {
  private providers: ProviderRecord[] = [
    this.provider({
      ...
      apiConnectionStatus: process.env.API_FOOTBALL_KEY ? "CONNECTED" : "NOT_CONFIGURED",
      healthStatus: process.env.API_FOOTBALL_KEY ? "CONNECTED" : "NOT_CONFIGURED",
      currentUsage: Number(process.env.API_FOOTBALL_REQUESTS_USED ?? 0),
      usageLimit: Number(process.env.API_FOOTBALL_DAILY_LIMIT ?? 10000),
